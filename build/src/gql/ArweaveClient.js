...
class ArweaveClient {
    ...
    smartweave = warp_contracts_1.WarpNodeFactory.memCachedBased(this.arweave).useArweaveGateway().build();
    warp = warp_contracts_1.WarpNodeFactory.memCached(this.arweave);
    sourceImpl = new warp_contracts_1.SourceImpl(this.arweave);
    async getPoolIds() {
