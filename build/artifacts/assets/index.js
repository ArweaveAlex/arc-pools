...
function getRandomContributor() {
    return __awaiter(this, void 0, void 0, function* () {
        const state = yield contract.readState();
...
const createAsset = (bundlrIn, arweaveIn, warpIn, contractIn, content, additionalPaths, config, contentType, articleTitle) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        try {
            ...
            console.log(assetId);
            yield createAtomicAsset(assetId, contentType === 'application/json' ? (0, exports.generateTweetName)(content) : articleTitle, contentType === 'application/json' ? (0, exports.generateTweetName)(content) : articleTitle, contentType === 'application/json' ? 'application/json' : 'web-page', contentType, additionalPaths, config);
        }
        catch (err) {
            throw new Error(err);
        }
...
function createAtomicAsset(assetId, name, description, assetType, contentType, additionalPaths, config) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const dataAndTags = yield createDataAndTags(assetId, name, description, assetType, contentType, additionalPaths, config);
            console.log(dataAndTags);
            const atomicId = yield dispatchToBundler(dataAndTags, contentType);
            yield deployToWarp(atomicId, dataAndTags, contentType);
            return atomicId;
        }
        catch (e) {
            console.log(e);
...
function dispatchToBundler(dataAndTags, contentType) {
    return __awaiter(this, void 0, void 0, function* () {
...
function deployToWarp(atomicId, dataAndTags, contentType) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let { data, tags } = dataAndTags;
            const tx = yield arweave.createTransaction({ data });
            tags.map((t) => tx.addTag(t.name, t.value));
            yield arweave.transactions.sign(tx, jwk);
            tx.id = atomicId;
            let price = yield arweave.transactions.getPrice(parseInt(tx.data_size));
...
function createDataAndTags(assetId, name, description, assetType, contentType, additionalPaths, config) {
    return __awaiter(this, void 0, void 0, function* () {
        const tokenHolder = yield getRandomContributor();
