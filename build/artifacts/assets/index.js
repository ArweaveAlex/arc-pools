...
var createAsset = function (bundlrIn, arweaveIn, warpIn, contractIn, content, additionalPaths, config, contentType, articleTitle) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 8:
                console.log(assetId);
                return [4 /*yield*/, createAtomicAsset(assetId, contentType === 'application/json' ? (0, exports.generateTweetName)(content) : articleTitle, contentType === 'application/json' ? (0, exports.generateTweetName)(content) : articleTitle, contentType === 'application/json' ? 'application/json' : 'web-page', contentType, additionalPaths, config)];
            case 9:
                _a.sent();
                return [3 /*break*/, 11];
            case 10:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, createDataAndTags(assetId, name, description, assetType, contentType, additionalPaths, config)];
                case 1:
                    dataAndTags = _a.sent();
...
function deployToWarp(atomicId, dataAndTags, contentType) {
    return __awaiter(this, void 0, void 0, function () {
        var data, tags, tx_1, price, result, e_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
