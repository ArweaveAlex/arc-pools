...
function mineTweets(poolSlug) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, init(poolSlug)];
                case 1:
                    _a.sent();
                    ...
                    trackKeyWords = config.keywords;
                    trackUsers = config.userIDs;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, twitterClientV2.v2.search(query, params)];
                case 4:
                    r = _a.sent();
                    if (r.data.data)
                    ...
                    _a.label = 5;
                case 5:
                    if (r.meta.next_token) return [3 /*break*/, 3];
                    _a.label = 6;
                case 6:
...
function mineTweetsByUser(poolSlug, userName) {
    return __awaiter(this, void 0, void 0, function () {
        var user, uid, r, allTweets, params, ids;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, init(poolSlug)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, twitterClientV2.v2.userByUsername(userName)];
                case 2:
                    user = _a.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, twitterClientV2.v2.userTimeline(uid, params)];
                case 4:
                    r = _a.sent();
                    if (r.data.data)
                        allTweets = allTweets.concat(r.data.data);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, twitterClientV2.v1.tweets(ids.slice(j, j + 5))];
                case 2:
                    rParents = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, arweave.api.post("/graphql", query())];
                case 1:
                    response = _a.sent();
        ...
        return __generator(this, function (_v) {
            switch (_v.label) {
                ...
                case 3:
                    ...
                    mediaDir = p.join(tmpdir.path, "media");
                        ...
                        return __generator(this, function (_w) {
                            switch (_w.label) {
                                ...
                                case 1:
                                    ...
                                    linkPath = p.join(tmpdir.path, "/links/".concat(i));
                ...
                case 25:
                    ...
                    f = _c;
                    relPath = p.relative(tmpdir.path, f);
                    _v.label = 26;
                case 26:
                    ...
                    return [4 /*yield*/, fs_1.promises.readFile(p.resolve(f))];
                case 27:
                ...
                case 46:
                    ...
                    return [4 /*yield*/, (0, assets_1.createAsset)(bundlr, arweave, smartweave, contract, tweet, additionalPaths, config, "application/json", "")];
                case 47:
                    _v.sent();
                    return [3 /*break*/, 49];
                case 48:
